...
\section*{Autonomous AI Logistics}

The Lean file also proves an autonomous AI logistics chain.  First,
\texttt{autonomous\_logistics\_requires\_verification} specializes the already
proved theorem \texttt{not\_passV\_not\_admissible}: any logistics decision path
that bypasses Verification $V$ is not admissible under $\mathrm{Adm}_{B,V}$.

Second, \texttt{admissible\_autonomous\_logistics\_needs\_assurance} proves that
any admissible autonomous AI logistics path must pass through Verification.
This is the formal role of AI assurance in the model.

Third,
\texttt{hiroshima\_structural\_basis\_for\_world\_standard\_ai\_logistics}
combines that assurance requirement with
\texttt{hiroshima\_conditioned\_unique}.  The conclusion is not that logistics
systems cannot be built or operated elsewhere.  The conclusion is that the
responsibility architecture and assurance anchor for a world-standard
autonomous AI logistics system are structurally justified from Hiroshima rather
than from an arbitrary city.
...
\begin{itemize}
  ...
  Hiroshima is the unique city satisfying both.
  ...
  the responsibility architecture and assurance anchor.
